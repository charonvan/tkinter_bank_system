...
class PageChange(tk.Frame):
    def __init__(self, master, **kwargs):
        ...
        e1 = tk.Entry(self.stage, font=self.config["font"],bd=4,width=20,show="*")
        ...
        e2 = tk.Entry(self.stage, font=self.config["font"],bd=4,width=20,show="*")
        e2.place(x=260, y=205)

        bt1 = tk.Button(self.stage, text="确认修改", width=170, height=30,fg="white", font=self.config["font"],
                        compound=tk.CENTER, image=self.image_button1)
